...
def game_loop(args):
    # ALIVE is an external global variable that is asking this function to stop and return if set to False
    pygame.init()
    pygame.font.init()
    world = None
    ...
    try:
        ...
        while True:
            print("CARLA_WINDOW: ", globals.CARLA_WINDOW)
            if globals.CARLA_WINDOW == False:
